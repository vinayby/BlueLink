...
LIST(APPEND BLUESPEC_BSC_SIM_OPTIONS -sim ${BLUESPEC_BSC_OPTIONS})

LIST(APPEND BLUESPEC_BSC_VERILOG_OPTIONS -verilog ${BLUESPEC_BSC_OPTIONS})
...
## NOTE: BSC -verilog outputs its files to the same folder as the source file, NOT its working directory
	...
	ADD_CUSTOM_COMMAND(
		...
		COMMAND ${BLUESPEC_BSC_EXECUTABLE} ${BLUESPEC_BSC_VERILOG_OPTIONS} -g ${MODULE} -p ${BLUESPEC_BSC_PATH} -bdir ${BLUESPEC_BSC_BDIR} ${PACKAGE}.bsv 
